...
1.  **Create a Gatsby site.**
    ...
    gatsby new sample-site https://github.com/t73liu/gatsby-engineer-starter
    ```
...
1.  **Open the source code and start editing!**
    ...
    Open the `sample-site` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
